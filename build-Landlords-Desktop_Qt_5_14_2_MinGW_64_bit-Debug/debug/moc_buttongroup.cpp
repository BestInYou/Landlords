...
#include <memory>
#include "../../Landlords/buttongroup.h"
...
QT_MOC_LITERAL(3, 23, 8), // "playHand"
QT_MOC_LITERAL(4, 32, 4), // "pass"
QT_MOC_LITERAL(5, 37, 8), // "betPoint"
QT_MOC_LITERAL(6, 46, 3) // "bet"

    },
    "ButtonGroup\0startGame\0\0playHand\0pass\0"
    "betPoint\0bet"
};
...
void ButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonGroup::startGame)) {
                *result = 0;
                return;
            }
        }
